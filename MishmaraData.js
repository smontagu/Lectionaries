const Mishmara = [
  ...
  [
    ...
    ["'Psalms.74-79'", "תהלים עד עד עט"],
    ["'Mishnah Moed Katan', 'Mishnah Horayot'", "מועד קטן<br>הוריות"]
  ],
  [
    ["'Parashat Vayeshev'", "וישב"],
    ["'I Samuel.26-31', 'II Samuel.1-7,",
     "שמואל א כו עד סופו<br>שמואל ב א עד ז"],
    ["'Psalms.80-90'", "תהלים פ עד צ"],
    ["'Mishnah Yevamot'", "יבמות"]
  ],
  [
    ["'Parashat Miketz'", "מקץ"],
    ["'II Samuel.8-18'", "שמואל ב א ח עד יח"],
  ...
  [
    ["'Parashat Bo'", "בא"],
    ["'I Kings.20-22', 'II Kings.1-5'", "מלכים א כ עד סופו<br>מלכים ב א עד ה"],
